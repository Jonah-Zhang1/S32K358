...
/* Check if Mcu_VS_0_PBcfg.c file and Dem.h file are of the same Autosar version */
...
/* Check if Mcu_VS_0_PBcfg.c file and Mcu.h file are of the same vendor */
#if (MCU_VS_0_PBCFG_VENDOR_ID_C != MCU_VENDOR_ID)
    #error "Mcu_VS_0_PBcfg.c and Mcu.h have different vendor ids"
#endif

/* Check if Mcu_VS_0_PBcfg.c file and Mcu.h file are of the same Autosar version */
...
/* Check if Mcu_VS_0_PBcfg.c file and Mcu.h file are of the same Software version */
