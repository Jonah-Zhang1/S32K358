...
#define ETH_43_GMAC_PBCFG_VS_0_AR_RELEASE_MINOR_VERSION_C      7
#define ETH_43_GMAC_PBCFG_VS_0_AR_RELEASE_REVISION_VERSION_C   0
#define ETH_43_GMAC_PBCFG_VS_0_SW_MAJOR_VERSION_C              3
#define ETH_43_GMAC_PBCFG_VS_0_SW_MINOR_VERSION_C              0
#define ETH_43_GMAC_PBCFG_VS_0_SW_PATCH_VERSION_C              0
...
static const Eth_43_GMAC_ClockCfgType Eth_43_GMAC_aClockConfigPB_VS_0[1U] =
{
    ...
    {
        160000000U, /* Frequency of the application interface (in Hz) */
