...
#ifdef GMAC_0_RXRING_2_DATA
    /*! @brief Reception data buffers for Rx Ring 2 */
    VAR_ALIGN(uint8 GMAC_0_RxRing_2_DataBuffer[(GMAC_0_MAX_RXBUFF_SUPPORTED * GMAC_0_MAX_RXBUFFLEN_SUPPORTED)], FEATURE_GMAC_BUFF_ALIGNMENT_BYTES)
#endif
...
#ifdef GMAC_0_TXRING_2_DATA
    /*! @brief Transmission data buffers for Tx Ring 2 */
    VAR_ALIGN(uint8 GMAC_0_TxRing_2_DataBuffer[(GMAC_0_MAX_TXBUFF_SUPPORTED * GMAC_0_MAX_TXBUFFLEN_SUPPORTED)], FEATURE_GMAC_BUFF_ALIGNMENT_BYTES)
#endif
...
#ifdef GMAC_0_RXRING_2_DESCR
    /*! @brief Reception buffer descriptors for Rx Ring 2 */
    VAR_ALIGN(Gmac_Ip_BufferDescriptorType GMAC_0_RxRing_2_DescBuffer[GMAC_0_MAX_RXBUFF_SUPPORTED], FEATURE_GMAC_BUFFDESCR_ALIGNMENT_BYTES)
#endif
...
#ifdef GMAC_0_TXRING_2_DESCR
    /*! @brief Transmission buffer descriptors for Tx Ring 2 */
    VAR_ALIGN(Gmac_Ip_BufferDescriptorType GMAC_0_TxRing_2_DescBuffer[GMAC_0_MAX_TXBUFF_SUPPORTED], FEATURE_GMAC_BUFFDESCR_ALIGNMENT_BYTES)
#endif
