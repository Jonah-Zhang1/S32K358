...
*/
#define CAN_43_FLEXCAN_HWCONTROLLER_SUPPORT    8U
...
*/
#define CAN_43_FLEXCAN_LPDU_CALLOUT_FUNC_ENABLE    (STD_ON)
...
*/
#define CAN_43_FLEXCAN_LPDU_CALLOUT_SUPPORT    (STD_ON)
#define CAN_43_FLEXCAN_LPDU_CALLOUT_FUNC_CALLED    CanLPduReceiveCallout
