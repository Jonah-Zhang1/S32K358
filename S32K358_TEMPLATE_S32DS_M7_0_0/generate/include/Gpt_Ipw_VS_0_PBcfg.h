...
#define GPT_IPW_AR_RELEASE_MINOR_VERSION_VS_0_PBCFG_H     7
#define GPT_IPW_AR_RELEASE_REVISION_VERSION_VS_0_PBCFG_H  0
#define GPT_IPW_SW_MAJOR_VERSION_VS_0_PBCFG_H             3
 ...
 */
extern Gpt_Ipw_HwInstanceConfigType Gpt_Ipw_HwInstanceConfig_PB_VS_0[1U];

/** 
 * @brief   Gpt channels IP related configuration array
 */
extern Gpt_Ipw_HwChannelConfigType Gpt_Ipw_ChannelConfig_PB_VS_0[1U];
