 ...
 */
#define WDG_IPW_NO_OF_INSTANCES            (3U)

/**
 * @brief  This define initializes all type of wdg instances to WDG_IPW_INIT_ARRAY
 */
#define WDG_IPW_INIT_ARRAY {WDG_IPW_UNINIT_IP, WDG_IPW_UNINIT_IP, WDG_IPW_UNINIT_IP }
...
#define WDG_IPW_ENABLE_INSTANCE1      (STD_OFF)
#define WDG_IPW_ENABLE_INSTANCE2      (STD_OFF)
...
#define WDG_IPW_ENABLE_DIRECT_SERVICE_INSTANCE2 (STD_OFF)
...
#define WDG_IPW_ISR1_USED (SWT_IP_ISR1_USED)
#define WDG_IPW_ISR2_USED (SWT_IP_ISR2_USED)
...
#define WDG_IPW_CLEAR_RESET_REQUEST_INSTANCE1 (SWT_IP_CLEAR_RESET_REQUEST_INSTANCE1)
#define WDG_IPW_CLEAR_RESET_REQUEST_INSTANCE2 (SWT_IP_CLEAR_RESET_REQUEST_INSTANCE2)
