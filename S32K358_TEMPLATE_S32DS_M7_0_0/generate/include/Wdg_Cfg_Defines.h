 ...
 */
#define WDG_INIT_PREVIOUS_MODE_ARRAY {WDGIF_OFF_MODE, WDGIF_OFF_MODE, WDGIF_OFF_MODE }

/**
 * @brief  This define initializes to WDG_UNINIT for variable that indicated the state of the driver
 */
#define WDG_INIT_STATUS_ARRAY {WDG_UNINIT, WDG_UNINIT, WDG_UNINIT }
...
#define WDG_INSTANCE2 (WDG_IPW_ENABLE_INSTANCE2)
...
#define WDG_43_INSTANCE2_VERSION_INFO_API (STD_OFF)
...
#define WDG_DIRECT_SERVICE_INSTANCE2 (WDG_IPW_ENABLE_DIRECT_SERVICE_INSTANCE2)
...
#define WDG_CLEAR_RESET_REQUEST_INSTANCE1 (WDG_IPW_CLEAR_RESET_REQUEST_INSTANCE1)
#define WDG_CLEAR_RESET_REQUEST_INSTANCE2 (WDG_IPW_CLEAR_RESET_REQUEST_INSTANCE2)
...
#define WDG_ISR2_USED (WDG_IPW_ISR2_USED)
