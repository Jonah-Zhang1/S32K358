...
#define SWT_IP_ENABLE_INSTANCE1 (STD_OFF)
#define SWT_IP_ENABLE_INSTANCE2 (STD_OFF)
...
*/
#define SWT_IP_INSTANCE0_INITIAL_TIMEOUT_U16 ((uint16)2000)
#define SWT_IP_INSTANCE0_MAX_TIMEOUT_U16 ((uint16)7000)

/**
* @brief  This macros indicate the Wdg timeout value for Wdg module.
*/

#define SWT_IP_INSTANCE0_TIMEOUT_VALUE_ARRAY  {(uint32)0,(uint32)30, (uint32)20}

#define SWT_IP_INSTANCE1_TIMEOUT_VALUE_ARRAY  {(uint32)0,(uint32)0, (uint32)0}

#define SWT_IP_INSTANCE2_TIMEOUT_VALUE_ARRAY  {(uint32)0,(uint32)0, (uint32)0}
/**
* @brief  This macros indicate the Wdg timeout array for Wdg module.
*/
#define SWT_TIMEOUT_VALUE_ARRAY { SWT_IP_INSTANCE0_TIMEOUT_VALUE_ARRAY \
,SWT_IP_INSTANCE1_TIMEOUT_VALUE_ARRAY \
,SWT_IP_INSTANCE2_TIMEOUT_VALUE_ARRAY \
}
...
*/
#define SWT_IP_ENABLE_DIRECT_SERVICE_INSTANCE0 (STD_OFF)
#define SWT_IP_ENABLE_DIRECT_SERVICE_INSTANCE1 (STD_OFF)
#define SWT_IP_ENABLE_DIRECT_SERVICE_INSTANCE2 (STD_OFF)

/**
* @brief  This variable will indicate if the Swt Direct Service feature is activated
*/
#define SWT_IP_ENABLE_DIRECT_SERVICE (STD_OFF)
...
#define SWT_IP_CLEAR_RESET_REQUEST_INSTANCE1 (STD_OFF)
#define SWT_IP_CLEAR_RESET_REQUEST_INSTANCE2 (STD_OFF)
...
#define SWT_IP_ISR1_USED (STD_OFF)
#define SWT_IP_ISR2_USED (STD_OFF)
 ...
 */
#define SWT_IP_RRR_SUPPORT (0x00000007UL)
