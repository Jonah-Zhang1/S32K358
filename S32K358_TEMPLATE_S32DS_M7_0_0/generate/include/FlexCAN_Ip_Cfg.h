...
#define FLEXCAN_IP_FEATURE_INSTANCE_6_MAX_MB_NUM    (64U)

/* @brief Maximum number of Message Buffers supported for payload size 8 for CAN7 */
#define FLEXCAN_IP_FEATURE_INSTANCE_7_MAX_MB_NUM    (64U)
...
#define FLEXCAN_IP_FEATURE_MAX_MB_NUM_ARRAY { \
                        ...
                        FLEXCAN_IP_FEATURE_INSTANCE_6_MAX_MB_NUM, \
                        FLEXCAN_IP_FEATURE_INSTANCE_7_MAX_MB_NUM \
}
