...
Jump functions:
  Jump functions of caller  Wdg_43_Instance0_SetMode/34:
  Jump functions of caller  Wdg_43_Instance0_SetTriggerCondition/33:
  Jump functions of caller  Wdg_43_Instance0_Init/31:
  Jump functions of caller  Gpt_EnableNotification/30:
  Jump functions of caller  Gpt_Init/29:
  Jump functions of caller  Swt_Ip_Swt0_Isr/28:
  Jump functions of caller  Platform_SetIrq/27:
  Jump functions of caller  PIT_0_ISR/26:
  Jump functions of caller  Platform_InstallIrqHandler/25:
  Jump functions of caller  Platform_Init/24:
  Jump functions of caller  Mcu_SetMode/23:
  Jump functions of caller  Mcu_DistributePllClock/22:
  Jump functions of caller  Mcu_GetPllStatus/21:
  Jump functions of caller  Mcu_InitClock/20:
  Jump functions of caller  Mcu_Init/19:
  Jump functions of caller  Port_Init/17:
  Jump functions of caller  main/16:
    callsite  main/16 -> Wdg_43_Instance0_SetMode/34 : 
       no arg info
    callsite  main/16 -> Wdg_43_Instance0_SetTriggerCondition/33 : 
       no arg info
    callsite  main/16 -> Wdg_43_Instance0_SetTriggerCondition/33 : 
       no arg info
    callsite  main/16 -> Wdg_43_Instance0_SetMode/34 : 
    ...
    callsite  main/16 -> Wdg_43_Instance0_SetTriggerCondition/33 : 
       no arg info
    callsite  main/16 -> Wdg_43_Instance0_Init/31 : 
       no arg info
    callsite  main/16 -> Gpt_EnableNotification/30 : 
       no arg info
    callsite  main/16 -> Gpt_Init/29 : 
       no arg info
    callsite  main/16 -> Platform_SetIrq/27 : 
       no arg info
    callsite  main/16 -> Platform_InstallIrqHandler/25 : 
       no arg info
    callsite  main/16 -> Platform_SetIrq/27 : 
       no arg info
    callsite  main/16 -> Platform_InstallIrqHandler/25 : 
       no arg info
    callsite  main/16 -> Platform_Init/24 : 
       no arg info
    callsite  main/16 -> Mcu_SetMode/23 : 
       no arg info
    callsite  main/16 -> Mcu_DistributePllClock/22 : 
       no arg info
    callsite  main/16 -> Mcu_GetPllStatus/21 : 
       no arg info
    callsite  main/16 -> Mcu_InitClock/20 : 
       no arg info
    callsite  main/16 -> Mcu_Init/19 : 
       no arg info
    callsite  main/16 -> Port_Init/17 : 
       no arg info
  Jump functions of caller  delay/15:
  Jump functions of caller  Wdg_CallBackNotification0/14:

 Propagating constants:

Not considering delay/15 for cloning; -fipa-cp-clone disabled.
...
Lattices:
  ...
  Node: delay/15:
    param [0]: BOTTOM
         ...
         int VARYING
        AGGS BOTTOM
  Node: Wdg_CallBackNotification0/14:
...
;; Function Wdg_CallBackNotification0 (Wdg_CallBackNotification0, funcdef_no=13, decl_uid=11201, cgraph_uid=14, symbol_order=14)

Modification phase of node Wdg_CallBackNotification0/14
...
;; Function delay (delay, funcdef_no=14, decl_uid=11204, cgraph_uid=15, symbol_order=15)

Modification phase of node delay/15
...
;; Function main (main, funcdef_no=15, decl_uid=11215, cgraph_uid=16, symbol_order=16) (executed once)

Modification phase of node main/16
main ()
{
  uint8 index;
