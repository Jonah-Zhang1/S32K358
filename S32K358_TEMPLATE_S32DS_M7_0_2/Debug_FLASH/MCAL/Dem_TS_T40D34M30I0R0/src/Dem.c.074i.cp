...
Jump functions:
  ...
  Jump functions of caller  Dem_ReportErrorStatusPreExtData/6:
    callsite  Dem_ReportErrorStatusPreExtData/6 -> Sys_GetCoreID/7 : 
       no arg info
  Jump functions of caller  Dem_SetEventStatus/5:
    callsite  Dem_SetEventStatus/5 -> Sys_GetCoreID/7 : 
       no arg info

 Propagating constants:

Not considering Dem_ReportErrorStatusPreExtData/6 for cloning; -fipa-cp-clone disabled.
Not considering Dem_SetEventStatus/5 for cloning; -fipa-cp-clone disabled.
...
;; Function Dem_SetEventStatus (Dem_SetEventStatus, funcdef_no=0, decl_uid=5954, cgraph_uid=1, symbol_order=5)
...
;; Function Dem_ReportErrorStatusPreExtData (Dem_ReportErrorStatusPreExtData, funcdef_no=1, decl_uid=5959, cgraph_uid=2, symbol_order=6)
