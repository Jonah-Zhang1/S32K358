...
Jump functions:
  ...
  Jump functions of caller  Dem_BufferOverflow/6:
    callsite  Dem_BufferOverflow/6 -> Sys_GetCoreID/7 : 
       no arg info
  Jump functions of caller  Dem_GetEventCount/5:
    callsite  Dem_GetEventCount/5 -> Sys_GetCoreID/7 : 
       no arg info
  Jump functions of caller  Dem_GetEvent/4:
    callsite  Dem_GetEvent/4 -> Sys_GetCoreID/7 : 
       no arg info
  Jump functions of caller  Dem_ClearEvents/3:
    callsite  Dem_ClearEvents/3 -> Sys_GetCoreID/7 : 
       no arg info
  Jump functions of caller  Dem_TestLastReportErrorStatusPreExtData/2:
    callsite  Dem_TestLastReportErrorStatusPreExtData/2 -> Sys_GetCoreID/7 : 
       no arg info
  Jump functions of caller  Dem_TestNoError/1:
    callsite  Dem_TestNoError/1 -> Sys_GetCoreID/7 : 
       no arg info
  Jump functions of caller  Dem_TestLastReportErrorStatus/0:
    callsite  Dem_TestLastReportErrorStatus/0 -> Sys_GetCoreID/7 : 
       no arg info

 Propagating constants:

Not considering Dem_GetEvent/4 for cloning; -fipa-cp-clone disabled.
Not considering Dem_TestLastReportErrorStatusPreExtData/2 for cloning; -fipa-cp-clone disabled.
Not considering Dem_TestLastReportErrorStatus/0 for cloning; -fipa-cp-clone disabled.
...
Lattices:
  Node: Dem_BufferOverflow/6:
  Node: Dem_GetEventCount/5:
  Node: Dem_GetEvent/4:
    param [0]: BOTTOM
         ctxs: BOTTOM
    ...
    param [2]: BOTTOM
         ...
         int VARYING
        AGGS BOTTOM
  Node: Dem_ClearEvents/3:
  Node: Dem_TestLastReportErrorStatusPreExtData/2:
    param [0]: BOTTOM
         ctxs: BOTTOM
         Bits unusable (BOTTOM)
         int VARYING
    ...
    param [3]: BOTTOM
         ...
         int VARYING
        AGGS BOTTOM
  Node: Dem_TestNoError/1:
  Node: Dem_TestLastReportErrorStatus/0:
    param [0]: BOTTOM
         ctxs: BOTTOM
         Bits unusable (BOTTOM)
         int VARYING
...
;; Function Dem_TestLastReportErrorStatus (Dem_TestLastReportErrorStatus, funcdef_no=0, decl_uid=5962, cgraph_uid=1, symbol_order=0)

Modification phase of node Dem_TestLastReportErrorStatus/0
...
;; Function Dem_TestNoError (Dem_TestNoError, funcdef_no=1, decl_uid=5964, cgraph_uid=2, symbol_order=1)

Modification phase of node Dem_TestNoError/1
Dem_TestNoError ()
{
  uint32 u32CoreId;
  uint32 counter;
...
;; Function Dem_TestLastReportErrorStatusPreExtData (Dem_TestLastReportErrorStatusPreExtData, funcdef_no=2, decl_uid=5969, cgraph_uid=3, symbol_order=2)

Modification phase of node Dem_TestLastReportErrorStatusPreExtData/2
...
;; Function Dem_ClearEvents (Dem_ClearEvents, funcdef_no=3, decl_uid=5971, cgraph_uid=4, symbol_order=3)

Modification phase of node Dem_ClearEvents/3
Dem_ClearEvents ()
{
  uint32 u32CoreId;
  unsigned char _1;
...
;; Function Dem_GetEvent (Dem_GetEvent, funcdef_no=4, decl_uid=5975, cgraph_uid=5, symbol_order=4)

Modification phase of node Dem_GetEvent/4
...
;; Function Dem_GetEventCount (Dem_GetEventCount, funcdef_no=5, decl_uid=5977, cgraph_uid=6, symbol_order=5)

Modification phase of node Dem_GetEventCount/5
Dem_GetEventCount ()
{
  uint32 u32CoreId;
  unsigned char _1;
...
;; Function Dem_BufferOverflow (Dem_BufferOverflow, funcdef_no=6, decl_uid=5979, cgraph_uid=7, symbol_order=6)

Modification phase of node Dem_BufferOverflow/6
Dem_BufferOverflow ()
{
  uint32 u32CoreId;
  unsigned char _1;
