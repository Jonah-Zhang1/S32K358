...
Clock_Ip_CMU_ClockFailInt/1 (Clock_Ip_CMU_ClockFailInt) @062058c0
  Type: function
  ...
  Calls: 
Mcu_Cmu_ClockFail_IRQHandler/0 (Mcu_Cmu_ClockFail_IRQHandler) @062052a0
...
;; Function Mcu_Cmu_ClockFail_IRQHandler (Mcu_Cmu_ClockFail_IRQHandler, funcdef_no=0, decl_uid=6823, cgraph_uid=1, symbol_order=0)
