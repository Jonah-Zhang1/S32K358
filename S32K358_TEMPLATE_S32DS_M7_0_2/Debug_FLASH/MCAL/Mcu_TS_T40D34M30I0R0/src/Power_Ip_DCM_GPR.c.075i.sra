Creating summary for Power_Ip_DCM_GPR_GlobalPadkeepingConfig/1:
  Descriptor for parameter 0 ConfigD.6347
    not a candidate for splitting


Creating summary for Power_Ip_DCM_GPR_Config/0:
  Descriptor for parameter 0 ConfigPtrD.6343
    by_ref with 0 pass throughs
        * Access to offset: 0, size: 8, type: const boolean, alias_ptr_type: _Bool *, nonarg: 1, reverse: 0
...
Summary for node Power_Ip_DCM_GPR_GlobalPadkeepingConfig/1:
  Descriptor for parameter 0:
    not a candidate for splitting


Summary for node Power_Ip_DCM_GPR_Config/0:
  Descriptor for parameter 0:
    not a candidate for splitting



Function Power_Ip_DCM_GPR_Config/0 disqualified because it cannot be made local.
Function Power_Ip_DCM_GPR_GlobalPadkeepingConfig/1 disqualified because it cannot be made local.
