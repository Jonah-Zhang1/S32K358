...
Not considering Ram_Ip_InitRamSection/0 for cloning; -fipa-cp-clone disabled.
...
;; Function Ram_Ip_InitRamSection (Ram_Ip_InitRamSection, funcdef_no=0, decl_uid=6038, cgraph_uid=1, symbol_order=0)
