Creating summary for Clock_Ip_CMU_ClockFailInt/9:


Creating summary for Clock_Ip_CMU_GetInterruptStatus/8:
  Descriptor for parameter 0 IndexCmuD.6898
    not a candidate for splitting


Creating summary for Clock_Ip_EnableCmuFcFceRefCntLfrefHfref/7:
...
Creating summary for Clock_Ip_SetCmuFcFceRefCntLfrefHfref/6:
  Descriptor for parameter 0 ConfigD.6876
    not a candidate for splitting
  Descriptor for parameter 1 IndexD.6877
    not a candidate for splitting


Creating summary for Clock_Ip_ResetCmuFcFceRefCntLfrefHfref/5:
  Descriptor for parameter 0 ConfigD.6873
    not a candidate for splitting
...
Creating summary for Clock_Ip_ClockMonitorEmpty_Disable/3:
  Descriptor for parameter 0 NameD.6858
    (locally) unused
    not a candidate for splitting


Creating summary for Clock_Ip_ClockMonitorEmpty_Set/2:
  Descriptor for parameter 0 ConfigD.6854
    unused with 0 call_uses
    by_ref with 0 pass throughs
  Descriptor for parameter 1 IndexD.6855
    unused with 0 call_uses
    not a candidate
----------------------------------------
  Descriptor for parameter 0 ConfigD.6854
...
Creating summary for Clock_Ip_ClockMonitorEmpty/1:
  Descriptor for parameter 0 ConfigD.6851
    unused with 0 call_uses
    by_ref with 0 pass throughs
----------------------------------------
  Descriptor for parameter 0 ConfigD.6851
...
Summary for node Clock_Ip_CMU_ClockFailInt/9:
  No parameter information. 

  Summary for edge Clock_Ip_CMU_ClockFailInt/9->Clock_Ip_ReportClockErrors/14:
    return value ignored

Summary for node Clock_Ip_CMU_GetInterruptStatus/8:
  Returns value
  Descriptor for parameter 0:
    not a candidate for splitting


Summary for node Clock_Ip_EnableCmuFcFceRefCntLfrefHfref/7:
  Descriptor for parameter 0:
    not a candidate for splitting
...
Summary for node Clock_Ip_DisableCmuFcFceRefCntLfrefHfref/4:
  ...
  Summary for edge Clock_Ip_DisableCmuFcFceRefCntLfrefHfref/4->SchM_Exit_Mcu_MCU_EXCLUSIVE_AREA_01/20:
    return value ignored
  Summary for edge Clock_Ip_DisableCmuFcFceRefCntLfrefHfref/4->Clock_Ip_ReportClockErrors/14:
    return value ignored
    Parameter 0:
    Parameter 1:
      Scalar param sources: 0
  Summary for edge Clock_Ip_DisableCmuFcFceRefCntLfrefHfref/4->Clock_Ip_TimeoutExpired/19:
  Summary for edge Clock_Ip_DisableCmuFcFceRefCntLfrefHfref/4->Clock_Ip_StartTimeout/18:
    return value ignored
  Summary for edge Clock_Ip_DisableCmuFcFceRefCntLfrefHfref/4->SchM_Enter_Mcu_MCU_EXCLUSIVE_AREA_01/17:
    return value ignored

Summary for node Clock_Ip_ClockMonitorEmpty_Disable/3:
  Descriptor for parameter 0:
    (locally) unused
    not a candidate for splitting


Summary for node Clock_Ip_ClockMonitorEmpty_Set/2:
  Descriptor for parameter 0:
    (locally) unused
    param_size_limit: 4, size_reached: 0, by_ref
  Descriptor for parameter 1:
...
Summary for node Clock_Ip_ClockMonitorEmpty/1:
  Descriptor for parameter 0:
    (locally) unused
    param_size_limit: 4, size_reached: 0, by_ref
...
Function Clock_Ip_ClockMonitorEmpty/1 disqualified because it cannot be made local.
Function Clock_Ip_ClockMonitorEmpty_Set/2 disqualified because it cannot be made local.
Function Clock_Ip_ClockMonitorEmpty_Disable/3 disqualified because it cannot be made local.
...
Function Clock_Ip_EnableCmuFcFceRefCntLfrefHfref/7 disqualified because it cannot be made local.
Function Clock_Ip_CMU_GetInterruptStatus/8 disqualified because it cannot be made local.
Function Clock_Ip_CMU_ClockFailInt/9 disqualified because it cannot be made local.
