Creating summary for Clock_Ip_CgmXPcfsSdurDivcDiveDivs/4:
  Descriptor for parameter 0 ConfigD.6835
    not a candidate for splitting
  Descriptor for parameter 1 CfgIndexD.6836
    not a candidate for splitting


Creating summary for Clock_Ip_ProgressiveFrequencyClockSwitchEmpty/3:
  Descriptor for parameter 0 ConfigD.6831
    unused with 0 call_uses
    by_ref with 0 pass throughs
  Descriptor for parameter 1 IndexD.6832
    unused with 0 call_uses
    not a candidate
----------------------------------------
  Descriptor for parameter 0 ConfigD.6831
...
Function Clock_Ip_ProgressiveFrequencyClockSwitchEmpty/3 disqualified because it cannot be made local.
Function Clock_Ip_CgmXPcfsSdurDivcDiveDivs/4 disqualified because it cannot be made local.
