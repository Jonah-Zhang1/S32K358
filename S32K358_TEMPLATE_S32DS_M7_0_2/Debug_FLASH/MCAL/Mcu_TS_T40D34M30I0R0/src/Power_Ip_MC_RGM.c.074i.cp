...
Jump functions:
  Jump functions of caller  Power_Ip_MC_RGM_ClearDesResetFlags.part.0/16:
    callsite  Power_Ip_MC_RGM_ClearDesResetFlags.part.0/16 -> Power_Ip_StartTimeout/11 : 
       no arg info
    callsite  Power_Ip_MC_RGM_ClearDesResetFlags.part.0/16 -> Power_Ip_TimeoutExpired/12 : 
       no arg info
    callsite  Power_Ip_MC_RGM_ClearDesResetFlags.part.0/16 -> Power_Ip_ReportPowerErrors/13 : 
       no arg info
  Jump functions of caller  Power_Ip_MC_RGM_ClearFesResetFlags.part.0/15:
    callsite  Power_Ip_MC_RGM_ClearFesResetFlags.part.0/15 -> Power_Ip_StartTimeout/11 : 
       no arg info
    callsite  Power_Ip_MC_RGM_ClearFesResetFlags.part.0/15 -> Power_Ip_TimeoutExpired/12 : 
       no arg info
    callsite  Power_Ip_MC_RGM_ClearFesResetFlags.part.0/15 -> Power_Ip_ReportPowerErrors/13 : 
       no arg info
  Jump functions of caller  Power_Ip_MC_ME_GetPreviousMode/14:
  Jump functions of caller  Power_Ip_ReportPowerErrors/13:
  Jump functions of caller  Power_Ip_TimeoutExpired/12:
  Jump functions of caller  Power_Ip_StartTimeout/11:
  Jump functions of caller  Power_Ip_MC_RGM_ResetDuringStandby/10:
  Jump functions of caller  Power_Ip_MC_RGM_GetResetRawValue/9:
    callsite  Power_Ip_MC_RGM_GetResetRawValue/9 -> Power_Ip_MC_ME_GetPreviousMode/14 : 
       no arg info
    callsite  Power_Ip_MC_RGM_GetResetRawValue/9 -> Power_Ip_MC_RGM_ClearDesResetFlags/5 : 
       param 0: UNKNOWN
         value: 0x0, mask: 0x6006d759
         VR  [0, 1611061081]
    callsite  Power_Ip_MC_RGM_GetResetRawValue/9 -> Power_Ip_MC_RGM_ClearFesResetFlags/4 : 
       param 0: UNKNOWN
         value: 0x0, mask: 0x601113d9
         VR  [0, 1611731929]
  Jump functions of caller  Power_Ip_MC_RGM_GetResetReason/8:
    callsite  Power_Ip_MC_RGM_GetResetReason/8 -> Power_Ip_MC_RGM_ClearFesResetFlags/4 : 
       param 0: UNKNOWN
         value: 0x0, mask: 0x601113d9
         VR  [0, 1611731929]
    callsite  Power_Ip_MC_RGM_GetResetReason/8 -> Power_Ip_MC_RGM_CheckResetReason/7 : 
       param 0: UNKNOWN
       ...
       param 2: UNKNOWN
         ...
         VR  [1, -1]
    callsite  Power_Ip_MC_RGM_GetResetReason/8 -> Power_Ip_MC_RGM_ClearDesResetFlags/5 : 
       param 0: UNKNOWN
         value: 0x0, mask: 0x6006d759
         VR  [0, 1611061081]
    callsite  Power_Ip_MC_RGM_GetResetReason/8 -> Power_Ip_MC_RGM_CheckResetReason/7 : 
       ...
       param 2: UNKNOWN
         ...
         value: 0x0, mask: 0xfffffffc
         VR  [1, -1]
  Jump functions of caller  Power_Ip_MC_RGM_CheckResetReason/7:
  Jump functions of caller  Power_Ip_MC_RGM_ResetInit/6:
    callsite  Power_Ip_MC_RGM_ResetInit/6 -> Power_Ip_MC_RGM_ClearFesResetFlags/4 : 
       param 0: UNKNOWN
         value: 0x0, mask: 0xffffffff
         Unknown VR
  Jump functions of caller  Power_Ip_MC_RGM_ClearDesResetFlags/5:
    callsite  Power_Ip_MC_RGM_ClearDesResetFlags/5 -> Power_Ip_MC_RGM_ClearDesResetFlags.part.0/16 : 
       param 0: PASS THROUGH: 0, op nop_expr
         value: 0x0, mask: 0xffffffff
         Unknown VR
  Jump functions of caller  Power_Ip_MC_RGM_ClearFesResetFlags/4:
    callsite  Power_Ip_MC_RGM_ClearFesResetFlags/4 -> Power_Ip_MC_RGM_ClearFesResetFlags.part.0/15 : 
       param 0: PASS THROUGH: 0, op nop_expr
         value: 0x0, mask: 0xffffffff
         Unknown VR
...
Not considering Power_Ip_MC_RGM_ResetInit/6 for cloning; -fipa-cp-clone disabled.
...
Lattices:
  Node: Power_Ip_MC_RGM_ClearDesResetFlags.part.0/16:
    param [0]: VARIABLE
         ctxs: VARIABLE
         Bits: value = 0x0, mask = 0x6006d759
         uint32 [0, 1611061081]
        AGGS VARIABLE
  Node: Power_Ip_MC_RGM_ClearFesResetFlags.part.0/15:
    param [0]: VARIABLE
         ctxs: VARIABLE
         Bits unusable (BOTTOM)
         int VARYING
        AGGS VARIABLE
  Node: Power_Ip_MC_RGM_ResetDuringStandby/10:
  Node: Power_Ip_MC_RGM_GetResetRawValue/9:
  Node: Power_Ip_MC_RGM_GetResetReason/8:
  Node: Power_Ip_MC_RGM_CheckResetReason/7:
    param [0]: VARIABLE
         ctxs: VARIABLE
         Bits unusable (BOTTOM)
         int VARYING
        AGGS VARIABLE
    param [1]: 1 [loc_time: 3, loc_size: 19, prop_time: 0, prop_size: 0]
               0 [loc_time: 3, loc_size: 19, prop_time: 0, prop_size: 0]
         ctxs: VARIABLE
    ...
    param [2]: VARIABLE
         ...
         uint32 * [1B, +INF]
        AGGS VARIABLE
        ref offset 0: 0 [loc_time: 1, loc_size: 20, prop_time: 0, prop_size: 0]
  Node: Power_Ip_MC_RGM_ResetInit/6:
    param [0]: BOTTOM
         ctxs: BOTTOM
         Bits unusable (BOTTOM)
         int VARYING
...
Propagated bits info for function Power_Ip_MC_RGM_ClearDesResetFlags.part.0/16:
 param 0: value = 0x0, mask = 0x6006d759
Propagated bits info for function Power_Ip_MC_RGM_CheckResetReason/7:
...
Modification phase of node Power_Ip_MC_RGM_ClearDesResetFlags.part.0/16
Adjusting mask for param 0 to 0x6006d759
Setting value range of param 0 (now 0) [0, 1611061081]
...
Modification phase of node Power_Ip_MC_RGM_ResetInit/6
...
Modification phase of node Power_Ip_MC_RGM_GetResetReason/8
...
Modification phase of node Power_Ip_MC_RGM_GetResetRawValue/9
...
Modification phase of node Power_Ip_MC_RGM_ResetDuringStandby/10
