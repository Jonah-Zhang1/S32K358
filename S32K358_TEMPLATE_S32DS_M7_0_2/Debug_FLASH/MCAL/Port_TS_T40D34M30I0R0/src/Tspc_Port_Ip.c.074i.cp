...
;; Function Tspc_Port_Ip_EnableObeGroup (Tspc_Port_Ip_EnableObeGroup, funcdef_no=1, decl_uid=6694, cgraph_uid=2, symbol_order=1)
...
;; Function Tspc_Port_Ip_ConfigureObeGroup (Tspc_Port_Ip_ConfigureObeGroup, funcdef_no=2, decl_uid=6697, cgraph_uid=3, symbol_order=2)
