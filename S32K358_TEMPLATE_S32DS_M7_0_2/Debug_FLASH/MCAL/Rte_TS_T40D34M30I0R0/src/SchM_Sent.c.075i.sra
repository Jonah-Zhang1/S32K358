Creating summary for SchM_Exit_Sent_SENT_EXCLUSIVE_AREA_01/8:


Creating summary for SchM_Enter_Sent_SENT_EXCLUSIVE_AREA_01/7:


Creating summary for SchM_Exit_Sent_SENT_EXCLUSIVE_AREA_00/6:


Creating summary for SchM_Enter_Sent_SENT_EXCLUSIVE_AREA_00/5:


Creating summary for Sent_schm_read_msr/4:



========== IPA-SRA IPA stage ==========

Summary for node SchM_Exit_Sent_SENT_EXCLUSIVE_AREA_01/8:
  No parameter information. 

  Summary for edge SchM_Exit_Sent_SENT_EXCLUSIVE_AREA_01/8->Sys_GetCoreID/9:

Summary for node SchM_Enter_Sent_SENT_EXCLUSIVE_AREA_01/7:
  No parameter information. 

  Summary for edge SchM_Enter_Sent_SENT_EXCLUSIVE_AREA_01/7->Sys_GetCoreID/9:

Summary for node SchM_Exit_Sent_SENT_EXCLUSIVE_AREA_00/6:
  No parameter information. 

  Summary for edge SchM_Exit_Sent_SENT_EXCLUSIVE_AREA_00/6->Sys_GetCoreID/9:

Summary for node SchM_Enter_Sent_SENT_EXCLUSIVE_AREA_00/5:
  No parameter information. 

  Summary for edge SchM_Enter_Sent_SENT_EXCLUSIVE_AREA_00/5->Sys_GetCoreID/9:

Summary for node Sent_schm_read_msr/4:
  Returns value
  No parameter information. 



Function Sent_schm_read_msr/4 disqualified because it cannot be made local.
Function SchM_Enter_Sent_SENT_EXCLUSIVE_AREA_00/5 disqualified because it cannot be made local.
Function SchM_Exit_Sent_SENT_EXCLUSIVE_AREA_00/6 disqualified because it cannot be made local.
Function SchM_Enter_Sent_SENT_EXCLUSIVE_AREA_01/7 disqualified because it cannot be made local.
Function SchM_Exit_Sent_SENT_EXCLUSIVE_AREA_01/8 disqualified because it cannot be made local.
