...
Jump functions:
  ...
  Jump functions of caller  SchM_Exit_Ipcf_IPCF_EXCLUSIVE_AREA_00/4:
    callsite  SchM_Exit_Ipcf_IPCF_EXCLUSIVE_AREA_00/4 -> Sys_GetCoreID/5 : 
       no arg info
  Jump functions of caller  SchM_Enter_Ipcf_IPCF_EXCLUSIVE_AREA_00/3:
    callsite  SchM_Enter_Ipcf_IPCF_EXCLUSIVE_AREA_00/3 -> Sys_GetCoreID/5 : 
       no arg info
  Jump functions of caller  Ipcf_schm_read_msr/2:
...
Lattices:
  Node: SchM_Exit_Ipcf_IPCF_EXCLUSIVE_AREA_00/4:
  Node: SchM_Enter_Ipcf_IPCF_EXCLUSIVE_AREA_00/3:
  Node: Ipcf_schm_read_msr/2:
...
;; Function Ipcf_schm_read_msr (Ipcf_schm_read_msr, funcdef_no=0, decl_uid=5952, cgraph_uid=1, symbol_order=2)

Modification phase of node Ipcf_schm_read_msr/2
Ipcf_schm_read_msr ()
{
...
;; Function SchM_Enter_Ipcf_IPCF_EXCLUSIVE_AREA_00 (SchM_Enter_Ipcf_IPCF_EXCLUSIVE_AREA_00, funcdef_no=1, decl_uid=5946, cgraph_uid=2, symbol_order=3)

Modification phase of node SchM_Enter_Ipcf_IPCF_EXCLUSIVE_AREA_00/3
...
;; Function SchM_Exit_Ipcf_IPCF_EXCLUSIVE_AREA_00 (SchM_Exit_Ipcf_IPCF_EXCLUSIVE_AREA_00, funcdef_no=2, decl_uid=5948, cgraph_uid=3, symbol_order=4)

Modification phase of node SchM_Exit_Ipcf_IPCF_EXCLUSIVE_AREA_00/4
