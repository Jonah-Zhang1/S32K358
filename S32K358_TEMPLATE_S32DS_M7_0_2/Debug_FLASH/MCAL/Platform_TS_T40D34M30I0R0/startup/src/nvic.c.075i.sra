Creating summary for NVIC_SetPriority/3:
  Descriptor for parameter 0 IRQnD.9594
    not a candidate for splitting
  Descriptor for parameter 1 priorityD.9595
    not a candidate for splitting


Creating summary for NVIC_DisableIRQ/2:
  Descriptor for parameter 0 IRQnD.9591
    not a candidate for splitting


Creating summary for NVIC_EnableIRQ/1:
  Descriptor for parameter 0 IRQnD.9588
    not a candidate for splitting


Creating summary for NVIC_SetPriorityGrouping/0:
  Descriptor for parameter 0 PriorityGroupD.9585
    not a candidate for splitting
