...
Jump functions:
  Jump functions of caller  init_data_bss_core2/1:
...
;; Function init_data_bss (init_data_bss, funcdef_no=0, decl_uid=5742, cgraph_uid=1, symbol_order=0)
...
;; Function init_data_bss_core2 (init_data_bss_core2, funcdef_no=1, decl_uid=5744, cgraph_uid=2, symbol_order=1)

Modification phase of node init_data_bss_core2/1
init_data_bss_core2 ()
{
  uint32 j;
  uint32 i;
