...
Not considering System_Ip_ConfigIrq/6 for cloning; -fipa-cp-clone disabled.
Not considering System_Ip_SetAhbSlavePriority/5 for cloning; -fipa-cp-clone disabled.
...
;; Function System_Ip_SetAhbSlavePriority (System_Ip_SetAhbSlavePriority, funcdef_no=5, decl_uid=9596, cgraph_uid=6, symbol_order=5)
...
;; Function System_Ip_ConfigIrq (System_Ip_ConfigIrq, funcdef_no=6, decl_uid=9599, cgraph_uid=7, symbol_order=6)
...
;; Function System_Ip_ClearWriteAbortFlag (System_Ip_ClearWriteAbortFlag, funcdef_no=7, decl_uid=9601, cgraph_uid=8, symbol_order=7)
...
;; Function System_Ip_GetPlatformRevision (System_Ip_GetPlatformRevision, funcdef_no=8, decl_uid=9603, cgraph_uid=9, symbol_order=8)
